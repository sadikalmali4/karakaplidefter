...
function masaYokEkrani(){
  ...
  <div class="card">
    <h3>✅ Önce Bunu Dene: Kodla Katıl</h3>
    <div class="row">
  ...
  <div class="card">
    <h3>Grup Kur</h3>
    <div class="uyari" style="margin-bottom:12px">
      <b>Arkadaşların zaten bir grup kurduysa YENİ GRUP KURMA.</b>
      Kod isteyip yukarıdan katıl. Yeni grup kurarsan kendi ayrı defterini açmış olursun:
      onların maçları, borçları ve sicili sende görünmez, seninkiler de onlarda görünmez.
      İki defter sonradan birleştirilemez.
    </div>
...
async function masaKur(){
  ...
  /* Yeni grup, AYRI bir defter demek. Arkadaş grubunda en sık yapılan hata
     bu: kod beklemek yerine ikinci grup kurmak, sicil ikiye bölünüyor. */
  const NL = String.fromCharCode(10);
  if(!confirm(
    'Yeni bir grup kuruyorsun — bu AYRI bir defter olur.' + NL + NL +
    'Arkadaşların zaten bir grup kurduysa onların maçlarını, borçlarını ve sicilini ' +
    'GÖREMEZSİN; seninkiler de onlarda görünmez. İki defter sonradan birleştirilemez.' + NL + NL +
    'Grubu kuran sen değilsen: vazgeç, ondan davet linki ya da 6 haneli kod iste.' + NL + NL +
    'Yine de yeni grup kurulsun mu?')) return;
