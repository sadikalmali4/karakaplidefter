function viewAyar(){
  ...
  <div class="card">
    ...
    <div class="xs dim" style="margin-top:8px">${(typeof SAHIP!=="undefined"&&SAHIP)
      ? `Bu liste yalnız <b>üyesi olduğun</b> grupları gösterir. <b>Sahip yetkisiyle</b> sistemdeki
         bütün grupları görebilir ve kurucusu olmasan da silebilirsin — hemen aşağıdaki
         <b>🛡️ Sahip Paneli</b>.`
      : `Kendi kurmadığın bir grup listede görünse de silinemez — yalnız kuran silebilir.
         Üyesi olmadığın grubu ise kimse göremez (güvenlik kuralı).`}</div>
  </div>
  ...
  <div class="card tight center xs dim">Kara Kaplı Defter · sürüm 10.11 · bulut</div>`;
}
